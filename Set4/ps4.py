...
def evaluate_models_on_training(x, y, models):
    ...
    for f in models:
        ...
        pylab.title('Gráfico temperaturas/Ano')
        estYval = pylab.polyval(f,x)
        pylab.plot(x, estYval, label = 'R^2 %f' %r_squared(y, estYval)) 
...
models = generate_models(x1, y, [1,2])    
